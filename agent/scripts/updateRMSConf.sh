...
if [[ $ACTION == "configure" ]]; then
    ...
    if [[ ! -z $file_exist && $file_exist != " " ]]; then
        ...
        echo $RMS_CONF_BACKUP file not found
    fi

    file_exist=`ls $RMS_CONFIG_BACKUP`
    if [[ ! -z $file_exist && $file_exist != " " ]]; then
        file_exist=`ls $RMS_CONFIG`
        if [[ ! -z $file_exist && $file_exist != " " ]]; then
        ...
        echo $RMS_CONFIG_BACKUP file not found
    fi
fi
